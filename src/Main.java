...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Swiatlo semaforTestowySBL2D = new Swiatlo(new Polozenie(-1500, -2), "semafor_SBL2_tor_dolny");
        ...
        Swiatlo semaforTestowySBL2G = new Swiatlo(new Polozenie(1500, 2), "semafor_SBL2_tor_gorny");
...
//        Pociag pociagTestowy3 = new Pociag(30,20000,38.89,"222D",120, torTestowyD, przejazdTestowy);
...
//        Pociag pociagTestowy6 = new Pociag(600,200000,16.67,"333G",170, torTestowyG, przejazdTestowy);
        Pociag pociagTestowy7 = new Pociag(10,15000,44.44,"111D",60, torTestowyD, przejazdTestowy);
//
