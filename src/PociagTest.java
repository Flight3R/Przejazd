...
public class PociagTest {
    ...
    @Test
    public void sprawdzCzujniki() throws InterruptedException {
        ...
        do {
            sleep(200);
        } while (pociagTestowy.getPolozenie().getX() < czujnikTestowy1D.getPolozenie().getX()+50);

        assertTrue(sygnalizacjaTestowaL.isZapalone());
        assertTrue(sygnalizacjaTestowaP.isZapalone());
    }
